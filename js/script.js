// ============================================================
//  TRANSLATION DATA (đã sửa phần Languages)
// ============================================================
const T = {
    en: {
        ...
        nav: { profile: "Profile", chapters: "Chapters", portfolio: "Portfolio", abilities: "Abilities",
        ...
        chapters: {
            ...
            1: { number: "Chapter I", title: "Homeland · Vietnam",
            ...
            2: { number: "Chapter II", title: "The Leap · Arrival in Japan",
            ...
            3: { number: "Chapter III", title: "Prime Time · High School Years",
            ...
            4: { number: "Chapter IV", title: "A Clean Slate · Cybersecurity Volunteer",
            ...
            5: { number: "Chapter V", title: "Scholar · University",
            ...
            6: { number: "Chapter VI", title: "Horizon · What's Next",
        ...
        portfolio: {
            ...
            1: { stamp: "Impact", title: "Think Fraud",
                ...
                tags: "Anti-Fraud · Community · Education", status: "Status: Complete" },
            2: { stamp: "Craft", title: "Restaurant Cashier",
                ...
                tags: "Finance · Trust · Hospitality", status: "Status: Complete" },
            3: { stamp: "Obsession", title: "Global Elite",
                ...
                tags: "Tactics · CS2 · Faceit Lvl 10", status: "Status: Active" },
            4: { stamp: "Bridge", title: "Polyglot", summary: "Four languages, endless connections.",
                ...
                tags: "Vietnamese · Japanese · English · German", status: "Status: Active" }
        },
        abilities: {
            label: "Abilities",
            ...
            cat3: "Languages", // Đã đổi từ "The Voice"
            lang: {
        ...
        contact: {
            ...
            form: { name: "Name", email: "Email", subject: "Subject", message: "Message", submit: "Send Message",
                nameError: "Please enter your name", emailError: "Please enter a valid email",
                messageError: "Please enter a message", success: "✓ Message sent! I'll get back to you soon." }
        },
        ending: { title: "Save Point", message: "The story's still going.", continue: "Continue?",
        ...
        toast: { easterEgg: "✦ Secret found: Curious explorer, confirmed", gameOver: "💀 Game Over. Press Y to respawn.",
            respawn: "✦ Respawned. Keep exploring.", audioError: "⚠ Audio unavailable" }
    },
    vi: {
        ...
        nav: { profile: "Hồ sơ", chapters: "Các chương", portfolio: "Dự án", abilities: "Kỹ năng",
            journal: "Nhật ký", contact: "Liên hệ" },
        profile: {
            label: "Hồ sơ",
        ...
        chapters: {
            ...
            1: { number: "Chương I", title: "Quê nhà · Việt Nam",
            ...
            2: { number: "Chương II", title: "Cú nhảy · Đặt chân đến Nhật",
            ...
            3: { number: "Chương III", title: "Thời Prime · Những năm cấp ba",
            ...
            4: { number: "Chương IV", title: "Kẻ quay đầu · Tình nguyện an ninh mạng",
            ...
            5: { number: "Chương V", title: "Học giả · Đại học",
            ...
            6: { number: "Chương VI", title: "Chân trời · Điều tiếp theo",
        ...
        portfolio: {
            ...
            1: { stamp: "Tác động", title: "Think Fraud",
                ...
                tags: "Chống lừa đảo · Cộng đồng · Giáo dục", status: "Trạng thái: Hoàn thành" },
            2: { stamp: "Tay nghề", title: "Restaurant Cashier",
                ...
                tags: "Tài chính · Niềm tin · Ngành dịch vụ", status: "Trạng thái: Hoàn thành" },
            3: { stamp: "Đam mê", title: "Global Elite",
                ...
                tags: "Chiến thuật · CS2 · Faceit Lvl 10", status: "Trạng thái: Đang tiếp diễn" },
            4: { stamp: "Cầu nối", title: "Polyglot", summary: "Bốn ngôn ngữ, vô số kết nối.",
                ...
                tags: "Việt · Nhật · Anh · Đức", status: "Trạng thái: Đang tiếp diễn" }
        },
        abilities: {
            label: "Kỹ năng",
            ...
            cat3: "Ngôn ngữ", // Đã đổi từ "Tiếng nói"
            lang: {
                vi: "Tiếng Việt (Bản ngữ)",
                en: "Tiếng Anh (Thông thạo)",
                ja: "Tiếng Nhật (Thông thạo)"
            }
        },
        journal: {
        ...
        contact: {
            ...
            form: { name: "Tên", email: "Email", subject: "Chủ đề", message: "Lời nhắn", submit: "Gửi tin nhắn",
                nameError: "Vui lòng nhập tên của bạn", emailError: "Vui lòng nhập email hợp lệ",
                messageError: "Vui lòng nhập lời nhắn",
                success: "✓ Đã gửi! Mình sẽ phản hồi bạn sớm nhất có thể." }
        },
        ending: { title: "Điểm lưu", message: "Câu chuyện vẫn đang tiếp tục.", continue: "Tiếp tục?",
        ...
        toast: { easterEgg: "✦ Tìm thấy bí mật: Xác nhận là một kẻ ham khám phá",
            gameOver: "💀 Game Over. Nhấn Y để hồi sinh.", respawn: "✦ Đã hồi sinh. Tiếp tục khám phá thôi.",
    ...
    ja: {
        ...
        nav: { profile: "プロフィール", chapters: "チャプター", portfolio: "ポートフォリオ", abilities: "スキル",
            journal: "ジャーナル", contact: "連絡先" },
        profile: {
            label: "プロフィール",
        ...
        portfolio: {
            ...
            1: { stamp: "インパクト", title: "Think Fraud", summary: "5万人以上をネット詐欺から守る活動。",
                ...
                tags: "詐欺対策 · コミュニティ · 教育", status: "ステータス:完了" },
            2: { stamp: "職人技", title: "Restaurant Cashier", summary: "ラーメン店でレジと帳簿を3年間担当。",
                brief: "3年間、監査みたいに一円単位で数え続けた。シフトに入るたびに、責任ってものを少しずつ学んでいった感じ。一円のズレもなく合わせることは、完璧主義とかじゃなくて、僕なりのちゃんとやってますっていう証明だった。",
                tags: "経理 · 信頼 · 接客業", status: "ステータス:完了" },
            3: { stamp: "こだわり", title: "Global Elite", summary: "才能とひたすらの練習で頂点へ。",
                brief: "マウスさえ握れればゲームができると思ってるなら、CS:GO(CS2)をやってみてほしい。その考え、絶対変わるから。必要なのは本物の才能と、山ほどの過酷な練習量。反射神経とひたすらの練習が、今の自分を作った。",
                tags: "戦術 · CS2 · Faceitレベル10", status: "ステータス:継続中" },
            4: { stamp: "架け橋", title: "Polyglot", summary: "4つの言語、無限のつながり。",
                brief: "海外生活7年以上、3ヶ国語をマスターして、今4つ目に挑戦中。僕にとって言語って、単なる単語の集まりじゃなくて、誰かの世界にお邪魔するための入り口みたいなものなんだ。",
                tags: "ベトナム語 · 日本語 · 英語 · ドイツ語", status: "ステータス:継続中" }
        },
        abilities: {
            label: "スキル",
            ...
            skill7: "リサーチ",
            skill8: "サイバーセキュリティ基礎",
            cat3: "言語", // Đã đổi từ "声" (The Voice)
            lang: {
                vi: "ベトナム語 (ネイティブ)",
                en: "英語 (堪能)", // Thay ペラペラ → 堪能
                ja: "日本語 (堪能)"  // Thay ペラペラ → 堪能
            }
        },
        journal: {
            label: "シネマティックジャーナル",
        ...
        contact: {
            ...
            form: { name: "名前", email: "メールアドレス", subject: "件名", message: "メッセージ", submit: "送信する",
                nameError: "お名前を入力してください", emailError: "有効なメールアドレスを入力してください",
                messageError: "メッセージを入力してください", success: "✓ 送信完了！なるべく早く返信します。" }
        },
        ending: { title: "セーブポイント", message: "物語はまだ続いてる。", continue: "続ける?",
            reflection: "ここまで一緒に歩いてくれてありがとう。もしどこかに自分自身の旅の影を見つけてくれたなら、ぜひ聞かせてほしい。一緒に次の章を書いていこう。",
            signature: "Ross より" },
        toast: { easterEgg: "✦ 秘密を発見:探検好きな性格、確定", gameOver: "💀 Game Over. Yキーでリスポーン。",
            respawn: "✦ リスポーン完了。探検を続けよう。", audioError: "⚠ 音声が利用できません" }
    }
};
...
function applyLanguage(lang) {
    ...
    if (modal && modal.classList.contains('active')) {
        ...
        if (idx !== undefined && journalItemsData[idx] && descEl) descEl.textContent = journalItemsData[idx]
            .fullEl.textContent.trim();
    }

    document.title = { en: 'Ross Nguyen · Designer & Developer', vi: 'Ross Nguyen · Designer & Developer',
        ja: 'Ross Nguyen · Designer & Developer' } [lang] || 'Ross Nguyen · Designer & Developer';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!isTouch && mouseLight) {
        document.addEventListener('mousemove', e => { mx = e.clientX;
            my = e.clientY; }, { passive: true });
        document.addEventListener('mouseleave', () => { if (mouseLight) mouseLight.style.opacity = '0'; },
        { passive: true });
        document.addEventListener('mouseenter', () => { if (mouseLight) mouseLight.style.opacity = '1'; },
        { passive: true });
    }
    ...
    try {
        ...
        anim();
        let resizeTO;
        window.addEventListener('resize', () => { clearTimeout(resizeTO);
            resizeTO = setTimeout(resize, 120); }, { passive: true });
        new IntersectionObserver(entries => { canvasAnim = entries[0].isIntersecting; }, { threshold: .1 })
            .observe($('#hero'));
    } catch (_) { const c = $('#heroCanvas'); if (c) c.style.display = 'none'; }

    // ---- MAIN LOOP (orbs, lighting) ----
    let scrollY = 0,
        frameId = null,
        lastTime = 0;
    ...
    function mainLoop(time) {
        ...
        if (bg) {
            ...
            bg.style.background =
                `radial-gradient(ellipse at ${28 + p * 18}% ${18 - p * 10}%, rgba(212,163,115,${.06 + p * .05}), transparent 58%)`;
        }
    }
    ...
    audio.addEventListener('error', () => { audioErr = true;
        hideMusic();
    ...
    playBtn.addEventListener('click', () => {
        if (audioErr) return;
        if (audio.paused) {
            audio.play().catch(() => { audioErr = true;
                hideMusic();
                showToast('audioError'); });
        } else {
            audio.pause();
    ...
    document.addEventListener('touchmove', (e) => {
        if (volDragging) { e.preventDefault();
            setVolume(e.touches[0].clientX); }
    });
    ...
    function startVisualizer() {
        ...
        function draw() {
            ...
            for (let i = 0; i < bars; i++) {
                ...
                const height = maxHeight * val * 0.7 + maxHeight * 0.2 * Math.sin(i * 0.3 + time * 2.1) * 0.3 +
                    maxHeight * 0.2;
    ...
    document.addEventListener('keydown', e => {
        ...
        if (e.key === 'ArrowLeft' && modal.classList.contains('active')) { e.preventDefault();
            openModal(currentIndex - 1); }
        if (e.key === 'ArrowRight' && modal.classList.contains('active')) { e.preventDefault();
            openModal(currentIndex + 1); }
    });
    ...
    if (form) {
        form.addEventListener('submit', function(e) {
            ...
            if (!name.value.trim()) { nameErr.classList.add('show');
                valid = false; }
            if (!email.value.trim() || !email.value.includes('@')) { emailErr.classList.add('show');
                valid = false; }
            if (!message.value.trim()) { msgErr.classList.add('show');
                valid = false; }
            if (valid) {
                ...
                window.location.href =
                    `mailto:${to}?subject=${encodeURIComponent(subjectText)}&body=${encodeURIComponent(body)}`;
    ...
    document.addEventListener('visibilitychange', () => {
        if (document.hidden) {
            ...
            if (!frameId) { lastTime = performance.now();
                frameId = requestAnimationFrame(mainLoop); }
        }
    });
